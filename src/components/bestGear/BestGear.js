    ...
    <div className={classes.container}>
      <div className={classes.imgContainer}>
        <img
          ...
          srcSet={`${bestGearImgMobile} 759w, ${bestGearImgTablet} 1399w, ${bestGearImgDesktop} 1500w`}
          alt=""
        />
      </div>

      <div
        className={`${typography.alignCenter} ${classes.textContainer} ${typography.alignDesktopLeft}`}
      >
        <h2>
          bringing you the <span className={typography.orange}>best</span> audio
          gear
        </h2>
        <br />
        <br />
