  ...
  return (
    <div className = {classes.container}>
      ...
      <h3 className={classes.subSection}>Payment Method</h3>
       ...
       <button onClick={usingEmoney} className={classes.btn}>e-Money</button>
      <button onClick = {payingCash} className={classes.btn}>Cash on Delivery</button>
      </div>
      ...
      {isCash && <div className ={classes.cashOnDelivery}>
