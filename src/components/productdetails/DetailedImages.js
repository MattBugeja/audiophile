    ...
    <div className={classes.container}>
      <div className={classes.halfImages}>
        <div className={classes.imageHalfContainer}>
          <img className={classes.image} src={image1.mobile} alt={""} />
        </div>
        <div className={classes.imageHalfContainer}>
